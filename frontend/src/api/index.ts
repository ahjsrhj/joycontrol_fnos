...
export const apiService = {
  ...
  async pressButton(buttons: string[]): Promise<{ success: boolean }> {
    const response = await api.post<{ success: boolean }>("/api/button/press", {
      buttons,
    });
    return response.data;
  },
  ...
  async clickButton(buttons: string[]): Promise<{ success: boolean }> {
    const response = await api.post<{ success: boolean }>("/api/button/click", {
      buttons,
    });
    return response.data;
  },
  ...
  async setStick(
    ...
    const response = await api.post<{ success: boolean }>("/api/stick", {
      stick,
      x,
      y,
    });
